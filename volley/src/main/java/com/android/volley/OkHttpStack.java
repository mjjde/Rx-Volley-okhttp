...
public class OkHttpStack implements OkStack {
    ...
    public OkHttpStack(UrlRewriter urlRewriter, SSLSocketFactory sslSocketFactory) {
        ...
        this.mClient.setConnectTimeout(60, TimeUnit.SECONDS);
        this.mClient.setWriteTimeout(60, TimeUnit.SECONDS);
        this.mClient.setReadTimeout(60, TimeUnit.SECONDS);
...
//            connection.addRequestProperty(headerName, map.get(headerName));
        ...
        com.squareup.okhttp.Response okHttpResponse = mClient.newCall(builder.build()).execute();
